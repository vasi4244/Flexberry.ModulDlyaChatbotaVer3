...
moduleForAcceptance('[AGAT] Acceptance | i i s modul dlya chatbota ver3 анкетирование l');

test('testing i-i-s-modul-dlya-chatbota-ver3-анкетирование-l', function(assert) {
