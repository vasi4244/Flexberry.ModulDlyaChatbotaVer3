...
moduleForModel('i-i-s-modul-dlya-chatbota-ver3-настройки-опр', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-ver3-настройки-опр', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-ver3-настройки-опр',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
