...
moduleForModel('i-i-s-modul-dlya-chatbota-ver3-сотрудники', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-ver3-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-ver3-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
