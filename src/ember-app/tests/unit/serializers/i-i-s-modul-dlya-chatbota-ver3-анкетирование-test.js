...
moduleForModel('i-i-s-modul-dlya-chatbota-ver3-анкетирование', 'Unit | Serializer | i-i-s-modul-dlya-chatbota-ver3-анкетирование', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-dlya-chatbota-ver3-анкетирование',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
