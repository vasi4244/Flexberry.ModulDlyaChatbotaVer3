...
namespace IIS.Modul_dlya_chatbota_ver3
{
    ...
    public class Анкетирование : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_dlya_chatbota_ver3.DetailArrayOfСписок fСписок;
        ...
        public virtual IIS.Modul_dlya_chatbota_ver3.DetailArrayOfСписок Список
        {
            get
            {
                ...
                {
                    this.fСписок = new IIS.Modul_dlya_chatbota_ver3.DetailArrayOfСписок(this);
                }
                IIS.Modul_dlya_chatbota_ver3.DetailArrayOfСписок result = this.fСписок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АнкетированиеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетированиеE", typeof(IIS.Modul_dlya_chatbota_ver3.Анкетирование));
                }
            }
            ...
            public static ICSSoft.STORMNET.View АнкетированиеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетированиеL", typeof(IIS.Modul_dlya_chatbota_ver3.Анкетирование));
                }
            }
        }
    }
